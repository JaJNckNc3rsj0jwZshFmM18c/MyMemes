      ...
      fetch(
        ...
        .then((myJson) => {
          try {
            ...
            alert(
              "Hi, You can not access this page because you are not authorized. Please  login by clicking on this button. "
            );
          }
          ...
          this.setState({
            Personal_Ajax: this.state.Personal_Ajax.concat(
              this.Pushing_Objects
            ),
          });
        });
    }
...
export default withRouter(MemePost);